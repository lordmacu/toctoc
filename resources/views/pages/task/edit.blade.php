        ...
        <div class="card" >
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <form class="form" action="/tasks/{{$task->id}}" method="POST">
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$task->subject}}" id="projectinput1" class="form-control" name="subject" placeholder="Escribe el nombre de la tarea">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="projectinput2" name="priority" class="form-control">
                                            ...
                                            <option value="{{$key}}" @if($task->priority==$key) selected @endif  >{{$priority}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="projectinput2" name="status" class="form-control">
                                            ...
                                            <option value="{{$key}}" @if($task->status_id==$key) selected @endif  >{{$status}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class='input-group'>
                                            <input type='text' id="start_end_task" name="start_end_task" class="form-control daterange" value="{{$task->start_date}} - {{$task->end_date}}"  />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="projectinput2" name="privacy_id" class="form-control">
                                            ...
                                            <option value="{{$key}}" @if($task->privacy_id==$key) selected @endif  >{{$privacy}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="projectinput8" rows="5" class="form-control" name="description" placeholder="Sobre la Tarea">{{$task->description}}</textarea>
                            </div>
                        </div>
